...
function t8() {
    ...
    if (chbox.checked) {
        ...
        document.querySelector(".ch-8").oncontextmenu = null;
        console.log(false)
    }
    // не решил !
}
...
function t9() {
    document.querySelector('.div-91').src = "img/2.png";
    return false;
}
...
function t10() {
    document.querySelector('.div-101').src = "img/2.png";
}
...
function t11() {
    document.querySelector('.div-111').src = "img/2.png";
}
...
function t18() {
    document.querySelector('.div-18').innerHTML = document.querySelector('.div-18').clientWidth
}
...
let a = 10;
function t20() {
    document.querySelector('progress').value = a;
    a++
}
